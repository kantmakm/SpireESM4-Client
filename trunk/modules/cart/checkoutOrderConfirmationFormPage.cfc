<cfcomponent name="clientinfoform" extends="resources.page">
    ...
    <cffunction name="postObjectLoad">
		...
		<cfset variables.pageInfo.breadCrumbs = "Home~NULL~/|Checkout : Validate order~NULL">

		<cfset addObjectByModulePath('item_above_cols', 'cart', "", structnew(), 'cartprogressindicator')>

		<cfset addObjectByModulePath('middleItem_2_Content', 'cart', "", structnew(), 'checkoutorderconfirmationform')>
