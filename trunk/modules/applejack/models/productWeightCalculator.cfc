<cfcomponent name="ajproductweightcalculator">
	...
	<cffunction name="determineWeight">
		<cfargument name="productObj" required="true">
		...
		<cfset lcl.size_description = arguments.prodObj.getSizeDescription()>
		...
		<cfif arguments.type EQ "unit">
			<cfset lcl.unitsperitem = 1>
		<cfelseif arguments.type EQ "pack">
			<cfset lcl.unitsperitem = arguments.prodObj.getUnitsPerPack()>
		<cfelseif arguments.type EQ "case">
			<cfset lcl.unitsperitem = arguments.prodObj.getUnitsPerCase()>
		</cfif>
